...
// POST /api/uploadFile?oid=&filename=&contentType=   body: raw file bytes
// Stores the file in Blob (gzip-compressed when larger than the threshold) and
// records a row in raul_tax_files. Called server-to-server by the Next.js app.
