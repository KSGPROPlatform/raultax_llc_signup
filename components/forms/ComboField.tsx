...
// A "select or type" combobox: a dropdown of suggested options you can pick
// from, but you can also type any custom value (handy when your answer isn't in
// the list). Keyboard-accessible; same styling as the other fields.
export function ComboField({
  ...
  const matches = useMemo(() => {
    ...
    // Hide the list when the only option left is an exact echo of the input.
